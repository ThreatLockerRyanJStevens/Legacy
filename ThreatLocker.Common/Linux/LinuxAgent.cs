...
namespace ThreatLockerCommon.Linux
{
    ...
    public class LinuxAgentAuthentication
	{
		public Guid ComputerId { get; set; }
		public string AuthKey { get; set; }
	}

	public class LinuxAgentAuth
	{
		public Guid ComputerId { get; set; }
		public Guid OrganizationId { get; set; }
	...
	public class LinuxAgentCheckinInfo
	{
		public LinuxAgentAuth LinuxAgentAuth { get; set; }
		public LinuxComputer LinuxComputer { get; set; }
