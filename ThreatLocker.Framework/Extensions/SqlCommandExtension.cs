...
namespace ThreatLocker.Framework.Extensions
{
	public static class SqlCommandExtension
	{
        ...
        public static SqlCommand AddDateTime2Parameter(this SqlCommand cmd, string parameterName, DateTime value)
        {
            if (cmd is null)
            {
                return cmd;
            ...
            cmd.Parameters.Add(new SqlParameter(parameterName, SqlDbType.DateTime2)
            {
                Value = value
            });
		...
		public static SqlCommand AddSmallDateTimeParameter(this SqlCommand cmd, string parameterName, DateTime value)
		{
			if (cmd is null)
			{
				return cmd;
			...
			cmd.Parameters.Add(new SqlParameter(parameterName, SqlDbType.SmallDateTime)
			{
				Value = value
			});
